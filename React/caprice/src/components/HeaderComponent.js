                ...
                <Navbar dark expand="md">
                    <div className="container">
                        ...
                        <NavbarBrand className="mr-auto" href="/">
                            <img src="/assets/images/logo.png" height="30" width="60" alt='Ristorante Caprice' style={{marginLeft: "5px"}}/></NavbarBrand>
                    ...
                    <div className="container">
                        <div className="row row-header">
                            <div className="col-12 col-sm-6">
                                <h1>Ristorante Caprice</h1>
                                <p>We take inspiration from the World's best cuisines, and create a unique Caprice experience. Our lipsmacking creations will tickle your culinary senses!</p>
                            </div>
                        </div>
                    </div>
                </Jumbotron>
